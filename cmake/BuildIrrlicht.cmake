file(GLOB IRRLICHT_SOURCES "${CMAKE_SOURCE_DIR}/irrlicht/source/Irrlicht/*.cpp")

add_library(irrlicht STATIC ${IRRLICHT_SOURCES})

target_include_directories(irrlicht
    PUBLIC  ${CMAKE_SOURCE_DIR}/irrlicht/include
    PRIVATE ${CMAKE_SOURCE_DIR}/irrlicht/source/Irrlicht
)
...
# Link jpeg and png (built earlier in root CMakeLists.txt)
target_link_libraries(irrlicht PRIVATE jpeg png_static)

if (WIN32)
    if (DEFINED ENV{DXSDK_DIR})
        target_include_directories(irrlicht PRIVATE "$ENV{DXSDK_DIR}Include")
    else ()
        target_compile_definitions(irrlicht PUBLIC NO_IRR_COMPILE_WITH_DIRECT3D_9_)
    endif ()
    target_link_libraries(irrlicht PUBLIC opengl32)
endif ()

if (APPLE)
    file(GLOB IRRLICHT_MM_SOURCES "${CMAKE_SOURCE_DIR}/irrlicht/source/Irrlicht/*.mm")
    target_sources(irrlicht PRIVATE ${IRRLICHT_MM_SOURCES})
    target_compile_definitions(irrlicht PUBLIC GL_SILENCE_DEPRECATION)
    target_link_libraries(irrlicht PUBLIC "-framework OpenGL" "-framework Cocoa" "-framework IOKit" "-framework Carbon")
endif ()

if (UNIX AND NOT APPLE)
    target_link_libraries(irrlicht PUBLIC GL X11)
endif ()
