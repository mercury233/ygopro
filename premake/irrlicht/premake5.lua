project "irrlicht"
    ...
    defines {
        ...
        "NO_IRR_COMPILE_WITH_WEBP_WRITER_",
    ...
    files {
        ...
        "source/Irrlicht/libwebp/src/dec/alpha_dec.c",
        "source/Irrlicht/libwebp/src/dec/buffer_dec.c",
        "source/Irrlicht/libwebp/src/dec/frame_dec.c",
        "source/Irrlicht/libwebp/src/dec/idec_dec.c",
        "source/Irrlicht/libwebp/src/dec/io_dec.c",
        "source/Irrlicht/libwebp/src/dec/quant_dec.c",
        "source/Irrlicht/libwebp/src/dec/tree_dec.c",
        "source/Irrlicht/libwebp/src/dec/vp8_dec.c",
        "source/Irrlicht/libwebp/src/dec/vp8l_dec.c",
        "source/Irrlicht/libwebp/src/dec/webp_dec.c",
        "source/Irrlicht/libwebp/src/dsp/alpha_processing.c",
        "source/Irrlicht/libwebp/src/dsp/alpha_processing_sse2.c",
        "source/Irrlicht/libwebp/src/dsp/alpha_processing_sse41.c",
        "source/Irrlicht/libwebp/src/dsp/cpu.c",
        "source/Irrlicht/libwebp/src/dsp/dec.c",
        "source/Irrlicht/libwebp/src/dsp/dec_clip_tables.c",
        "source/Irrlicht/libwebp/src/dsp/dec_sse2.c",
        "source/Irrlicht/libwebp/src/dsp/dec_sse41.c",
        "source/Irrlicht/libwebp/src/dsp/filters.c",
        "source/Irrlicht/libwebp/src/dsp/filters_sse2.c",
        "source/Irrlicht/libwebp/src/dsp/lossless.c",
        "source/Irrlicht/libwebp/src/dsp/lossless_avx2.c",
        "source/Irrlicht/libwebp/src/dsp/lossless_sse2.c",
        "source/Irrlicht/libwebp/src/dsp/lossless_sse41.c",
        "source/Irrlicht/libwebp/src/dsp/rescaler.c",
        "source/Irrlicht/libwebp/src/dsp/rescaler_sse2.c",
        "source/Irrlicht/libwebp/src/dsp/upsampling.c",
        "source/Irrlicht/libwebp/src/dsp/upsampling_sse2.c",
        "source/Irrlicht/libwebp/src/dsp/upsampling_sse41.c",
        "source/Irrlicht/libwebp/src/dsp/yuv.c",
        "source/Irrlicht/libwebp/src/dsp/yuv_sse2.c",
        "source/Irrlicht/libwebp/src/dsp/yuv_sse41.c",
        "source/Irrlicht/libwebp/src/utils/bit_reader_utils.c",
        "source/Irrlicht/libwebp/src/utils/color_cache_utils.c",
        "source/Irrlicht/libwebp/src/utils/huffman_utils.c",
        "source/Irrlicht/libwebp/src/utils/palette.c",
        "source/Irrlicht/libwebp/src/utils/quant_levels_dec_utils.c",
        "source/Irrlicht/libwebp/src/utils/random_utils.c",
        "source/Irrlicht/libwebp/src/utils/rescaler_utils.c",
        "source/Irrlicht/libwebp/src/utils/thread_utils.c",
        "source/Irrlicht/libwebp/src/utils/utils.c",
    }
