...
bool ImageManager::Initial()  {
	...
	char head1[256];
		...
		BufferIO::EncodeUTF8(head1, daddy1);
		char dad1[300];
		sprintf(dad1, "textures/head/head_%1s.jpg", head1);
	tHead[0] = driver->getTexture(dad1);
	char head2[256];
		const wchar_t* daddy2 = mainGame->dInfo.clientname;
		BufferIO::EncodeUTF8(head2, daddy2);
		char dad2[300];
		sprintf(dad2, "textures/head/head_%1s.jpg", head2);
	tHead[1] = driver->getTexture(dad2);
	char head3[256];
		const wchar_t* daddy3 = mainGame->dInfo.hostname_tag;
		BufferIO::EncodeUTF8(head3, daddy3);
		char dad3[300];
		sprintf(dad3, "textures/head/head_%1s.jpg", head3);
	tHead[2] = driver->getTexture(dad3);
	char head4[256];
		const wchar_t* daddy4 = mainGame->dInfo.clientname_tag;
		BufferIO::EncodeUTF8(head4, daddy4);
		char dad4[300];
