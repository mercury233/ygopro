...
void Game::DrawMisc() {
	...
	if(!dInfo.isReplay && dInfo.player_type < 7 && dInfo.time_limit) {
		if(imageManager.tClock) {
			driver->draw2DImage(imageManager.tClock, ResizeCardMid(580, 32, 598, 50, 598, 41), recti(0, 0, 34, 34), 0, 0, true);
			driver->draw2DImage(imageManager.tClock, ResizeCardMid(695, 32, 713, 50, 713, 41), recti(0, 0, 34, 34), 0, 0, true);
		}
		DrawShadowText(numFont, dInfo.str_time_left[0], Resize(598, 32, 628, 51), Resize(0, 1, 2, 0), dInfo.time_color[0], 0xff000000, true, false, 0);
		...
		driver->draw2DImage(imageManager.tCover[0], ResizeCardMid(546, 32, 559, 50, 559, 41), rect<s32>(0, 0, CARD_IMG_WIDTH, CARD_IMG_HEIGHT), 0, 0, true);
		...
		DrawShadowText(numFont, dInfo.str_card_count[0], Resize(556, 32, 581, 51), Resize(0, 1, 2, 0), dInfo.card_count_color[0], 0xff000000, true, false, 0);
		...
		*/
		...
		driver->draw2DImage(imageManager.tCover[0], ResizeCardMid(596, 32, 606, 50, 606, 41), rect<s32>(0, 0, CARD_IMG_WIDTH, CARD_IMG_HEIGHT), 0, 0, true);
		...
		DrawShadowText(numFont, dInfo.str_card_count[0], Resize(607, 32, 634, 51), Resize(0, 1, 2, 0), dInfo.card_count_color[0], 0xff000000, true, false, 0);
