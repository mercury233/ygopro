...
void Game::DrawDeckBd() {
	...
	//monster count
	driver->draw2DImage(imageManager.tCardType, Resize(645, 136, (645+14+3/8), 156), Resize(0, 0, 23, 32), 0, 0, true);
	...
	//spell count
	driver->draw2DImage(imageManager.tCardType, Resize(695, 136, (695+14+3/8), 156), Resize(23, 0, 46, 32), 0, 0, true);
    ...
    //trap count
	driver->draw2DImage(imageManager.tCardType, Resize(745, 136, (745+14+3/8), 156), Resize(46, 0, 69, 32), 0, 0, true);
	...
	//fusion count
	driver->draw2DImage(imageManager.tCardType, Resize(595, 440, (595+14+3/8), 460), Resize(0, 32, 23, 64), 0, 0, true);
	...
	//synchro count
	driver->draw2DImage(imageManager.tCardType, Resize(645, 440, (645+14+3/8), 460), Resize(23, 32, 46, 64), 0, 0, true);
	...
	//XYZ count
	driver->draw2DImage(imageManager.tCardType, Resize(695, 440, (695+14+3/8), 460), Resize(46, 32, 69, 64), 0, 0, true);
	...
	//link count
	driver->draw2DImage(imageManager.tCardType, Resize(745, 440, (745+14+3/8), 460), Resize(0, 64, 23, 96), 0, 0, true);
	...
	//monster count
	driver->draw2DImage(imageManager.tCardType, Resize(645, 537, (645+14+3/8), 557), Resize(0, 0, 23, 32), 0, 0, true);
	...
	//spell count
	driver->draw2DImage(imageManager.tCardType, Resize(695, 537, (695+14+3/8), 557), Resize(23, 0, 46, 32), 0, 0, true);
    ...
    //trap count
	driver->draw2DImage(imageManager.tCardType, Resize(745, 537, (745+14+3/8), 557), Resize(46, 0, 69, 32), 0, 0, true);
