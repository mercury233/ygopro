...
void Game::DrawMisc() {
	...
	if(!dInfo.isReplay && dInfo.player_type < 7 && dInfo.time_limit) {
		...
		driver->draw2DImage(imageManager.tCover[0], ResizeCardMid(544, 32, 557, 50, 557, 41), rect<s32>(0, 0, 177, 254), 0, 0, true);
		driver->draw2DImage(imageManager.tCover[1], ResizeCardMid(746, 32, 759, 50, 759, 41), rect<s32>(0, 0, 177, 254), 0, 0, true);
		...
		*/
		...
		driver->draw2DImage(imageManager.tCover[0], ResizeCardMid(594, 32, 604, 50, 604, 41), rect<s32>(0, 0, 177, 254), 0, 0, true);
		driver->draw2DImage(imageManager.tCover[1], ResizeCardMid(694, 32, 706, 50, 706, 41), rect<s32>(0, 0, 177, 254), 0, 0, true);
