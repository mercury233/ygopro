...
namespace gui
{
	...
	public:
		...
		virtual const wchar_t* getListItem(u32 id);
		...
		virtual s32 getIcon(u32 id);

		//! removes an item from the list
		virtual void removeItem(u32 id) ;

		//! get the the id of the item at the given absolute coordinates
		virtual s32 getItemAt(s32 xpos, s32 ypos);
		...
		virtual bool hasItemOverrideColor(u32 index, EGUI_LISTBOX_COLOR colorType);
		...
		virtual IGUIScrollBar* getVerticalScrollBar();
