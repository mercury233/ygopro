...
void Game::ShowCardInfo(int code, bool resize) {
	...
	if(cd.type & TYPE_MONSTER) {
		...
		scrCardText->setRelativePosition(rect<s32>(287 * xScale - 20, (83 + offset_arrows) + offset, 287 * xScale, 324 * yScale));
			...
			stSetName->setRelativePosition(rect<s32>(15, 103, 296 * xScale, 126));
			stText->setRelativePosition(rect<s32>(15, 103 + offset, 287 * xScale, 324 * yScale));
			scrCardText->setRelativePosition(rect<s32>(287 * xScale - 20, 103 + offset, 287 * xScale, 324 * yScale));
		}
	} else {
