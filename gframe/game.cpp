...
bool Game::Initialize() {
	...
	wSearchWindow = env->addWindow(rect<s32>(220, 100, 800, 520), false, dataManager.GetSysString(1200));
	...
	ebSearchName = env->addEditBox(gameConf.searchname, rect<s32>(110, 25, 450, 50), true, wSearchWindow, EDITBOX_SEARCHCARD);
	ebSearchName->setTextAlignment(irr::gui::EGUIA_UPPERLEFT, irr::gui::EGUIA_CENTER);
	lstSearchCard = env->addListBox(rect<s32>(20, 50, 190, 160), wSearchWindow, LISTBOX_SEARCHCARD, true);
