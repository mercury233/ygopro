...
bool Game::Initialize() {
	...
	wSearchWindow = env->addWindow(rect<s32>(220, 100, 510, 195), false, dataManager.GetSysString(1284));
	...
	btnSearchAgree = env->addButton(rect<s32>(60, 60, 150, 85), wSearchWindow, BUTTON_SEARCH_AGREE, dataManager.GetSysString(1286));
	btnSearchCancel = env->addButton(rect<s32>(170, 60, 260, 85), wSearchWindow, BUTTON_SEARCH_CANCEL, dataManager.GetSysString(1287));
	//
